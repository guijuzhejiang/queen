...
class ModelParams(ParamGroup): 
    def __init__(self, parser, config, sentinel=False):
        ...
        #chage to your Depth Anything V2 model path
        self.depth_model_type = "da2"   # "midas", "da2"
        self.da2_model_encoder = "vitl"
        self.da2_input_size = 518
        self.depth_model_ckpt_da2 = "/media/zzg/GJ_disk01/pretrained_model/depth_anything_v2/depth_anything_v2_vitl.pth"
        # self.depth_model_ckpt_da2 = "/home/ubuntu/workspace/models/depth_anything_v2_vitl.pth"
