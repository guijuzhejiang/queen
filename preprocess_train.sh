...
# Usage example：
#   ./preprocess_train.sh /yourdatapath/dynerf/coffee_martini 1
...
if [ $# -lt 2 ]; then
  ...
  echo "Usage: ./preprocess_train.sh <workdir> <GPU_ID>"
  echo "Example: ./preprocess_train.sh /yourdatapath/dynerf/coffee_martini 1"
  exit 1
fi
